...
// Modified from lp-12-30.cpp, with vector<string> replaced with StrBlob

// With StrBlob.h and StrBlob.cpp included, which are modified from lp-12-02-03.cpp
...
using namespace std;
using lino = StrBlob::size_type;
using lsha = shared_ptr<set<StrBlob::size_type>>;
using tsha = shared_ptr<StrBlob>;
...
TextQuery::
TextQuery(istream & is) : txt(make_shared<StrBlob>())
{
	lino n = 0;
