...
*^ as of C++11, only four operators guarantee the order of evaluation: (1) `&&` (2) `||` (3) `?:` (4) `,`*

*Since C++17, it has been additionally guaranteed that the right-hand side of the assignment operator `=` is sequenced before the left-hand side. That is, from C++17 onwards, `i = i++ + 1;` is well defined.*
