...
// are references to a class named matrix. (b) A function named change_val that
// returns a vector<int> iterator and takes two parameters: One is an int and
// the other is an iterator for a vector<int>.
