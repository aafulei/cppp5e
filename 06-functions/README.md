...
> Write a header file named [`Chapter6.h`](Chapter6.h) that contains declarations for the functions you wrote for the exercises in Section 6.1 (p. 205).
...
> Write your own versions of the `fact.cc` and `factMain.cc` files. These files should include your [`Chapter6.h`](Chapter6.h) from the exercises in the previous section. Use these files to understand how your compiler supports separate compilation.
