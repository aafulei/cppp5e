...
- [Section 2.2 Variables](#exercise-29)
...
- [Section 2.3 Compound Types](#exercise-215)
...
- [Section 2.4 `const` Qualifier](#exercise-226)
...
- [Section 2.5 Dealing with Types](#exercise-233)
...
- [Section 2.6 Defining Our Own Data Structure](#exercise-239)
...
- [`02-04-signed-unsigned.cpp`](02-04-signed-unsigned.cpp)
...
- [`02-08-escape-sequence.cpp`](02-08-escape-sequence.cpp)
...
- [`02-18-pointer.cpp`](02-18-pointer.cpp)
...
Illegal - cannot initialize pointer `p` with an `int`, even if that `int` has value 0
...
- [`02-36-decltype.cpp`](02-36-decltype.cpp)
...
- [`02-37-decltype.cpp`](02-37-decltype.cpp)
...
## Section 2.6 Defining Our Own Data Structure
...
- [`02-39-missing-semicolon.cpp`](02-39-missing-semicolon.cpp)
...
- [`02-40-sales-data.cpp`](02-40-sales-data.cpp)
...
- [`02-41-read-books.cpp`](02-41-read-books.cpp) *rewrites* [`01-20-read-books.cpp`](../01-getting-started/01-20-read-books.cpp)

- [`02-41-sum-two-books.cpp`](02-41-sum-two-books.cpp) *rewrites* [`01-21-sum-two-books.cpp`](../01-getting-started/01-21-sum-two-books.cpp)

- [`02-41-sum-several-books.cpp`](02-41-sum-several-books.cpp) *rewrites* [`01-22-sum-several-books.cpp`](../01-getting-started/01-22-sum-several-books.cpp)

- [`02-41-count-books.cpp`](02-41-count-books.cpp) *rewrites* [`01-23-count-books.cpp`](../01-getting-started/01-23-count-books.cpp)

- [`02-41-bookstore.cpp`](02-41-bookstore.cpp) *rewrites* [`01-25-bookstore.cpp`](../01-getting-started/01-25-bookstore.cpp)
...
- [`Sales_data.h`](Sales_data.h)
  ...
  - [`02-42-read-books.cpp`](02-42-read-books.cpp) *rewrites* [`02-41-read-books.cpp`](02-41-read-books.cpp) *which rewrites* [`01-20-read-books.cpp`](../01-getting-started/01-20-read-books.cpp)

  - [`02-42-sum-two-books.cpp`](02-42-sum-two-books.cpp) *rewrites* [`02-41-sum-two-books.cpp`](02-41-sum-two-books.cpp) *which rewrites* [`01-21-sum-two-books.cpp`](../01-getting-started/01-21-sum-two-books.cpp)

  - [`02-42-sum-several-books.cpp`](02-42-sum-several-books.cpp) *rewrites* [`02-41-sum-several-books.cpp`](02-41-sum-several-books.cpp) *which rewrites* [`01-22-sum-several-books.cpp`](../01-getting-started/01-22-sum-several-books.cpp)

  - [`02-42-count-books.cpp`](02-42-count-books.cpp) *rewrites* [`02-41-count-books.cpp`](02-41-count-books.cpp) *which rewrites* [`01-23-count-books.cpp`](../01-getting-started/01-23-count-books.cpp)

  - [`02-42-bookstore.cpp`](02-42-bookstore.cpp) *rewrites* [`02-41-bookstore.cpp`](02-41-bookstore.cpp) *which rewrites* [`01-25-bookstore.cpp`](../01-getting-started/01-25-bookstore.cpp)
